...
export default function Home() {
    ...
    return (<div>
        ...
        <div style={{ width: '90%', paddingTop: '20px ', height: '530px', backgroundColor: 'pink', margin: '20px auto', borderRadius: '15px', boxShadow: ' rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px - 3px, rgba(0, 0, 0, 0.2) 0px - 3px 0px inset', overflowX: 'hidden' }} >
